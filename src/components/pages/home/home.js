            ...
            <div className="row">
              ...
              <div className="col-lg-5 col-md-12 col-sm-12">
                <div className="bag-35">
                  <img src={Img1} alt="" />
                  <h2>Testimonials</h2>
                  <p>This is a friendly farm that you can collect, grow and care for. In this game you have to feed your animals and complete quests for them, making them healthier and happier.</p>
                  <h6><span>Blessing Christopher</span> - Creative writer & Story Teller</h6>
                </div>
              </div>
            </div>
          </div>
